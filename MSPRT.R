  ...
  if(side!='both'){
    ...
    if(plot.it==T){
      ...
      if(decision=="accept"){
        ...
        if(LR[max(which(!is.na(LR)))]<(termination.threshold + Accept.threshold)/2){
    ...
    if(plot.it==T){
      ...
      if(AcceptedH0_n.r){
        ...
        if(LR.r[max(which(!is.na(LR.r)))]<(termination.threshold + Accept.threshold)/2){
      ...
      if(AcceptedH0_n.l){
        ...
        if(LR.l[max(which(!is.na(LR.l)))]<(termination.threshold + Accept.threshold)/2){
