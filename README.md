...
Article: [Pramanik, Johnson and Bhattacharya (2021)](https://www.sciencedirect.com/science/article/pii/S0022249621000109)
...
* **Input:**
  ...
  * **N2.increment:** Positive integer. Increment in sample size from Group-2 allowed while searching for the sample size that is required for achieving the higher level of significance.
