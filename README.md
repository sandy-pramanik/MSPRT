...
### **Type2.fixed_design** <font size="3"> [[List of all functions]](#key-functions) </font>
...
### **fixed_design.alt** <font size="3"> [[List of all functions]](#key-functions) </font>
...
### **UMPBT.alt** <font size="3"> [[List of all functions]](#key-functions) </font>
...
### **design.MSPRT** <font size="3"> [[List of all functions]](#key-functions) </font>
...
* **Output:** List. The list has the following named components in case of one-sided one-sample tests:
  ...
  * **Reject.threshold:** Positive numeric. Threshold for rejecting $H_0$ in the MSPRT.
  
  * **Accept.threshold:** Positive numeric. Threshold for accepting $H_0$ in the MSPRT.
...
### **OCandASN.MSPRT** <font size="3"> [[List of all functions]](#key-functions) </font>
...
### **implement.MSPRT** <font size="3"> [[List of all functions]](#key-functions) </font>
...
* **Output:** List. The list has the following named components in case of one-sided one-sample tests:
  ...
  * **UMPBT alternative** This stores the UMPBT alternative(s) as
  ...
  In case of two-sided tests at level of significance $\alpha$, the MSPRT carries out a right and a left sided test simultaneously at level of significance $\alpha/2$. In this case the outputs are same as above with following changes in components in the returned list:
    ...
    * *UMPBT* or *theta.UMPBT* is a list with two components named *'right'* and *'left'* corresponding to the right and left sided tests of size $\alpha/2$. Each of these 
